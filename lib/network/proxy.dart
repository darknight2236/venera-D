...
Future<String?> _getProxy() async {
  if ((appdata.settings[SettingKeys.proxy] as String).removeAllBlank == "direct") {
    return null;
  }
  if (appdata.settings[SettingKeys.proxy] != "system") return appdata.settings[SettingKeys.proxy];
